...
public class BanksAdapter extends ArrayAdapter<Banks> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView streets = convertView.findViewById(R.id.txtAddress);

        TextView atms = convertView.findViewById(R.id.txtAtms);

        TextView jobs = convertView.findViewById(R.id.txtJobs);

        TextView hours = convertView.findViewById(R.id.txtHours);
