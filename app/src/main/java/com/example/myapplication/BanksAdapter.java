...
public class BanksAdapter extends ArrayAdapter<com.example.myapplication.bba> {

    private Context mContext;
    private int mResourse;


    public BanksAdapter(@NonNull Context context, int resource, @NonNull ArrayList<com.example.myapplication.bba> objects)
    {
